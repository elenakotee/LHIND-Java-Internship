...
public class MyControllerAdvice extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<String> handleNotFoundException(ChangeSetPersister.NotFoundException notFoundException) {
		...
		return new ResponseEntity<String>("Handle not found", HttpStatus.NOT_FOUND);
	}
	...
	public ResponseEntity<String> handleConstraintViolationException(ConstraintViolationException constraintViolationException) {
		...
		return new ResponseEntity<String>("Constraint violation", HttpStatus.NOT_FOUND);
	}
	...
	public ResponseEntity<String> handleServletException(ServletException servletException) {
		...
		return new ResponseEntity<String>("Servlet Exception", HttpStatus.NOT_FOUND);
	}

	@ExceptionHandler(IOException.class)
	public ResponseEntity<String> handleIOException(IOException ioException) {
		logger.error("IOException exception \n");
		return new ResponseEntity<String>("IOException Exception", HttpStatus.BAD_REQUEST);
	}

	@ExceptionHandler(ExpiredJwtException.class)
	public ResponseEntity<String> handleExpiredJwtException(ExpiredJwtException expiredJwtException) {
		logger.error("Token is expired \n");
		return new ResponseEntity<String>("Your token is expired", HttpStatus.FORBIDDEN);
	}

	@ExceptionHandler(IllegalArgumentException.class)
	public ResponseEntity<String> handleIllegalArgumentException(IllegalArgumentException illegalArgumentException) {
		logger.error("Illegal argument exception \n");
		return new ResponseEntity<String>("Illegal argument exception", HttpStatus.BAD_REQUEST);
	}
	...
	public ResponseEntity<String> handleDisabledException(DisabledException disabledException) {
		...
		return new ResponseEntity<String>("User has been disabled", HttpStatus.FORBIDDEN);
	}
	...
	public ResponseEntity<String> handleBadCredentialsException(BadCredentialsException badCredentialsException) {
		...
		return new ResponseEntity<String>("Bad credentials from user", HttpStatus.BAD_REQUEST);
	}
	...
	public ResponseEntity<String> handleNoSuchElementException(NoSuchElementException noSuchElementException) {
		...
		return new ResponseEntity<String>("No data found in database", HttpStatus.NOT_FOUND);
	}
	...
	public ResponseEntity<String> handleEmptyResultDataAccessException(EmptyResultDataAccessException emptyResultDataAccessException) {
		...
		return new ResponseEntity<String>("Can't delete inexistent data", HttpStatus.NOT_FOUND);
	}
	...
	protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
		...
		return new ResponseEntity<Object>("Please change you http method type", HttpStatus.NOT_FOUND);
	}

	@Override
	protected ResponseEntity<Object> handleMissingPathVariable(MissingPathVariableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
		logger.error("Missing path variable \n");
		return new ResponseEntity<Object>("You are missing a path variable", HttpStatus.NOT_FOUND);
	}

	@Override
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
		logger.error("Http message not readable \n");
		return new ResponseEntity<Object>("Your message is not readable", HttpStatus.BAD_REQUEST);
	}

	@Override
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
		logger.error("Invalid method argument \n");
		return new ResponseEntity<Object>("Your method argument is invalid", HttpStatus.BAD_REQUEST);
	}
